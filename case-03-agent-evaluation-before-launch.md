...
**真实的连接点**：这个开场描述的问题，在[案例 1](./case-01-return-refund-agent-boundary.md)
...
|---|---|---|---|
| 第一轮 | 礼貌、迅速解决问题 | 系统里查无记录，Agent 却直接答应赔付——跟案例 2 "历史承诺争议"是同一个风险模式，只是这次出现在客服对话入口，不是退款申请入口 | AI 自行创造承诺 |
...
去独立判断这件事是否属实，跟案例 2 "无记录承诺"的判断逻辑一致——
...
其实是同一件事的三个阶段：**先弄清楚该怎么做（案例 1），再弄清楚现实
是怎么做的（案例 2），最后验证做出来的东西靠不靠谱（案例 3）**。
